...
def scatter_classes(xs, y, ax, show_labels=True, silhouette_coefficient=False, labels=[], **kwargs):
    ...
    for k in np.unique(y):
        ...
        if len(labels) == 0:
            ...
            label = "{}".format(labels[k])
        
        ax.scatter(x1, x2, label=label if show_labels else None, **kwargs)
